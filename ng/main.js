...
function mainCtl($scope, $location, $state) {
  ...
  mainVm.asideArr = [
    ...
    {title: '订单管理', subTitle:'Orders Management', icon: '', sref: 'order.receipt', path: '/order/receipt', isActive: false},
    {title: '售后服务', subTitle:'After-sales Service', icon: '', sref: 'service.setup', path: '/service/setup', isActive: false},
    {title: '配置管理', subTitle:'Configure Management', icon: '', sref: 'config.banner', path: '/config/banner', isActive: false},
    ...
    {title: '账号管理', subTitle:'Account Management', icon: '', sref: 'account.update', path: '/account/update', isActive: false},
  ];
